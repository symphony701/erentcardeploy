...
export class ClientService {
  ...
  //basePath = 'http://localhost:8105/api/v1/clients';
  //basePath = 'http://localhost:8105/api/v1/clients'
  basePath = 'https://users-erentcar.azurewebsites.net/api/v1/clients'
  //basePath = 'http://localhost:8105/api/v1/clients';
  ...
  /*login(email:String,password:String){
    ...
    return this.http.get<Client>(`${this.basePath}/email/${email}/password/${password}`, this.httpOptions)
      .pipe(
        retry(2),
