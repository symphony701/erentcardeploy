...
import {Brand} from "../app/common/model/brand";
...
export class BrandService {
  ...
  // basePath = 'http://localhost:8105/api/v1/brands';
  //basePath = 'http://localhost:8115/api/v1/brands';
  basePath = 'https://cars-erentcar.azurewebsites.net/api/v1/brands';
